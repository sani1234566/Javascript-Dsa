class Employee {
  constructor(name, last, email_id, age, dob, mobile, gender, doj, role) {
    this.name = name;
    this.last = last;
    this.email = email_id;
    this.age = age;
  ...
  Biodata() {
    return ` Employee name is : ${this.name} & Last Name is 
        ...
        & Mobile Number is ${this.mobile} Category is ${this.gender} Developer Role is ${this.role} `
  }
...
class Developer extends Employee {
  constructor(name, last, email_id,age,dob, mobile, gender, doj, role, sal, bonus, skill ) {
    
    super(name, last, email_id, age, dob, mobile, gender, doj, role);
